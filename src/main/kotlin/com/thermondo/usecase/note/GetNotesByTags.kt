 ...
 * having one or more [Tag]s associated
...
class GetNotesByTags(
    ...
    UseCase<GetNotesByTags.RequestModel, GetNotesByTags.ResultModel>() {
    ...
    class RequestModel(val authorId: String, val tags: List<String>) : UseCase.RequestModel
